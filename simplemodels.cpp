...
quad_cylinder( int a, int b, int c, int d, int n, int segments )
{
    ...
    tex_coords_cylinder[Index] = vec2(((float) n) / segments, 1.0);
    Index++;
}
...
colortube(void)
{
    float r = 0.5;
    Index = 0;
    //num_cap_points = segments*3;
    //num_body_points = segments*6;
    //num_bot_points = segments*3;
    for ( int n = 0; n < segments; n++ )
    {
        ...
        tex_coords_cylinder[Index] = vec2(0.5, 0.5);
        Index++;
        ...
        points_cylinder[Index].w = 1.0;
        normals_cylinder[Index] = vec3(0.0, 1.0, 0.0);
        tex_coords_cylinder[Index] = vec2(cos(t0)*0.5 + 0.5,
                                          sin(t0)*0.5 + 0.5);
        Index++;
        ...
        points_cylinder[Index].w = 1.0;
        normals_cylinder[Index] = vec3(0.0, 1.0, 0.0);
        tex_coords_cylinder[Index] = vec2(cos(t1)*0.5 + 0.5,
                                          sin(t1)*0.5 + 0.5);
        Index++;
    }
    ...
    for ( int n = 0; n < segments; n++ )
    {
        ...
        quad_cylinder( 0, 1, 2, 3, n, segments );
    }
